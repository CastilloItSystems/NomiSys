...
export const PERMISSION_CATALOG = [
  ...
  {
    code: 'crm.vehicles.create',
    description: 'Registrar vehículos de clientes',
  },
  {
    code: 'crm.vehicles.update',
    description: 'Actualizar vehículos de clientes',
  },
  {
    code: 'crm.vehicles.delete',
    description: 'Eliminar vehículos de clientes',
  },
  ...
  // CRM: Interacciones
  {
    ...
    description: 'Ver interacciones con clientes',
  },
  {
    code: 'crm.interactions.create',
    description: 'Registrar interacciones con clientes',
  },
  {
    code: 'crm.interactions.update',
    description: 'Actualizar interacciones con clientes',
  },
  {
    code: 'crm.interactions.delete',
    description: 'Eliminar interacciones con clientes',
  },
