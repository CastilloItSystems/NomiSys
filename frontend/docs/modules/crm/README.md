...
# Páginas (Routes)
app/(nomisys)/nomisys/crm/vehiculos/
├── page.tsx                  # /nomisys/crm/vehiculos
├── marcas/
│   └── page.tsx              # /nomisys/crm/vehiculos/marcas
└── modelos/
    └── page.tsx              # /nomisys/crm/vehiculos/modelos
...
```
CRM
├── Vehículos (/nomisys/crm/vehiculos)
├── Marcas (/nomisys/crm/vehiculos/marcas)
└── Modelos (/nomisys/crm/vehiculos/modelos)
```
