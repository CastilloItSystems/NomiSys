...
│   ├── (nomisys)/                # Route group para módulo nomisys
...
│   ├── nomisys/                  # Componentes del módulo nomisys
...
│   ├── AppMenuNomiSys.tsx        # Menú para nomisys
...
- Separación de contextos (main, nomisys, landing, etc.)
